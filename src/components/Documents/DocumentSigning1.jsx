    ...
    const [, drop] = useDrop(() => ({
        ...
        drop: (item, monitor) => {
            ...
            if (offset && docRect) {
                ...
                const x = offset.x - docRect.left;
                const y = offset.y - docRect.top;

                // Calculate which page was dropped on
                const pageHeight = docRect.height / numPages;
                const pageNumber = Math.floor(y / pageHeight) + 1;

                // Calculate position relative to the page
                const relativeY = y - (pageHeight * (pageNumber - 1));
                                    ...
                                    {Array.from(new Array(numPages), (el, index) => (
                                        <div key={index} className="relative">
                                            ...
                                            {signatureField && signatureField.pageNumber === index + 1 && (
                                                ...
                                                >
                                                    <span className="block text-black text-sm text-center">
                                                        Signature here
                                                    </span>
                                                </div>
                                            )}
...
export default DocumentSigner1;